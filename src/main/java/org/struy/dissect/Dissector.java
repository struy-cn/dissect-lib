...
import org.struy.dissect.fields.Field;
import org.struy.dissect.fields.FieldComparator;
import org.struy.dissect.fields.FieldFactory;
...
public class Dissector {
    ...
    private void dissectValues(final byte[] source, final ValueRef[] fieldValueRefs, final DissectResult result) {
        final Position position = new Position(source, offsetOfFirstField);
